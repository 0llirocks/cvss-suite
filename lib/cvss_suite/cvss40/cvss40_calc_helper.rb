    ...
    def score
      ...
      max_vectors.each do |max_vector|
        ...
        if [severity_distance_av, severity_distance_pr, severity_distance_ui, severity_distance_ac,
            ...
            severity_distance_ir, severity_distance_ar].some(met => met < 0)
          next
        end
      ...
      max_severity_eq1 = max_severity_data['eq1'][eq1_val] * step
      max_severity_eq2 = max_severity_data['eq2'][eq2_val] * step
      max_severity_eq3eq6 = max_severity_data['eq3eq6'][eq3_val][eq6_val] * step
      max_severity_eq4 = max_severity_data['eq4'][eq4_val] * step
