...
describe CvssSuite::Cvss40 do
  test_cases = [
    ...
    # { name: "reg-deptheq3eq6", cvss_string: "CVSS:4.0/AV:N/AC:H/AT:N/PR:H/UI:N/VC:N/VI:N/VA:H/SC:H/SI:H/SA:H/CR:L/IR:L/AR:L", expected_score: 5.8, expected_severity: "High" },
  ].each do |a|
